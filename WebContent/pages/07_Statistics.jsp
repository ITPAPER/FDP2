  ...
  <body>
   ...
   <div class="container" style="min-height:1700px;">
     ...
     <div id="left"> 
      ...
      <h4 class="charttitle btn btn-warning">질병 2</h4>
     	 <!-- 탭 버튼 구성 -->
      ...
      <h4 class="charttitle btn btn-warning">질병 3</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 4</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 5</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 6</h4>
      	<!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" id="mytab1">
            <li class="active"><a href="#dept" data-toggle="tab" data-deptno="1" id="ct11">성별</a></li>
      ...
      <h4 class="charttitle btn btn-warning">질병 7</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 8</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 9</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
      ...
      <h4 class="charttitle btn btn-warning">질병 10</h4>
     	 <!-- 탭 버튼 구성 -->
         <ul class="nav nav-tabs" >
