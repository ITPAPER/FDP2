...
<html lang="ko">
  ...
  <jsp:include page="./assets/inc/top.jsp" />
	...
	<div class="agrment1">
		...
		본 약관은 중앙응급의료센터에서 운영하는 사이트(이하 "당 사이트") 관련 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 당 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.<br/><br/>
		...
		①이용계약은 "회원"이 되고자 하는 자(이하 "가입신청자")가 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 "중앙응급의료센터"가 이러한 신청에 대하여 승낙함으로써 체결됩니다.<br/>
		②"중앙응급의료센터"는 "가입신청자"의 신청에 대하여 "서비스" 이용을 승낙함을 원칙으로 합니다. 다만, "중앙응급의료센터"는 다음 각 호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.<br/>
		1.가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 단 "중앙응급의료센터"의 회원 재가입 승낙을 얻은 경우에는 예외로 함.<br/>
		2.실명이 아니거나 타인의 명의를 이용한 경우<br/>
		3.허위의 정보를 기재하거나, "중앙응급의료센터"가 제시하는 내용을 기재하지 않은 경우<br/>
		4.응급의료와 관련된 업무를 수행하지 않는 경우<br/>
		5.이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우<br/>
		③제1항에 따른 신청에 있어 "중앙응급의료센터"는 "회원"의 종류에 따라 전문기관을 통한 실명확인 및 본인인증을 요청할 수 있습니다.<br/>
		④"중앙응급의료센터"는 서비스관련설비의 여유가 없거나, 기술상 또는 업무상 문제가 있는 경우에는 승낙을 유보할 수 있습니다.<br/>
		⑤제2항과 제4항에 따라 회원가입신청의 승낙을 하지 아니하거나 유보한 경우, "중앙응급의료센터"는 원칙적으로 이를 가입신청자에게 알리도록 합니다.<br/>
		⑥이용계약의 성립 시기는 "중앙응급의료센터"가 가입완료를 신청절차 상에서 표시한 시점으로 합니다.<br/><br/>
		
		제 6 조 (위원회의 개인정보보호 의무 및 회원정보의 변경)<br/>
		
		①"중앙응급의료센터"는 "개인정보보호법" 등 관계 법령이 정하는 바에 따라 "회원"의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법 및 "중앙응급의료센터"의 개인정보취급방침이 적용됩니다. 다만, "중앙응급의료센터"의 공식 사이트 이외의 링크된 사이트에서는 "중앙응급의료센터"의 개인정보취급방침이 적용되지 않습니다.<br/>
		②"회원"은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 실명, 아이디 등은 수정이 불가능합니다.<br/>
		③"회원"은 회원가입신청 시 기재한 사항이 변경되었을 경우 온라인으로 수정을 하거나 전자우편 기타 방법으로 "중앙응급의료센터"에 대하여 그 변경사항을 통지하여야 합니다.<br/>
		④제3항의 변경사항을 "중앙응급의료센터"에 알리지 않아 발생한 불이익에 대하여 "중앙응급의료센터"는 책임지지 않습니다.<br/><br/>
		
		제 7 조 (“회원”의 정보보안에 대한 의무)<br/>
		
		①"회원"의 "아이디"와 "비밀번호"에 관한 관리책임은 "회원"에게 있으며, 이를 제3자가 이용하도록 하여서는 안 됩니다.<br/>
		②"중앙응급의료센터"는 "회원"의 "아이디"가 개인정보 유출 우려가 있거나, 반사회적 또는 미풍양속에 어긋나거나 "중앙응급의료센터" 및 "중앙응급의료센터"의 운영자로 오인한 우려가 있는 경우, 해당 "아이디"의 이용을 제한할 수 있습니다.<br/>
		③"회원"은 "아이디" 및 "비밀번호"가 도용되거나 제3자가 사용하고 있음을 인지한 경우에는 이를 즉시 "중앙응급의료센터"에 통지하고 "중앙응급의료센터"의 안내에 따라야 합니다.<br/>
		④제3항의 경우에 해당 "회원"이 "중앙응급의료센터"에 그 사실을 통지하지 않거나, 통지한 경우에도 "중앙응급의료센터"의 안내에 따르지 않아 발생한 불이익에 대하여 "중앙응급의료센터"는 책임지지 않습니다.<br/><br/>
		...
		1. 당 사이트가 제공하는 서비스, 그에 필요한 소프트웨어, 이미지, 마크, 로고, 디자인, 서비스명칭, 정보 및 상표 등과 관련된 지식재산권 및 기타 권리는 중앙응급의료센터에 소유권이 있습니다.<br/>
		...
		본 서비스 이용과 관련하여 발생한 분쟁에 대해 소송이 제기될 경우 중앙응급의료센터 본원 소재지 관할 법원을 전속적 관할 법원으로 합니다.<br/><br/>
	 ...
	 <div class="agrment2">
		가. 개인정보의 수집•이용 목적<br/>
		"중앙응급의료센터"는 다음의 목적을 위해 개인정보를 수집 및 이용합니다. 수집된 개인정보는 다음의 목적이외의 용도로는 이용되지 않으며 수집 목적이 변경될 경우 사전에 알리고 동의를 받을 예정입니다.<br/><br/>
