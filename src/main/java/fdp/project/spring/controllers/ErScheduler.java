	    	...
	    	for(Item abc : list ){
	    		for(Itema def : list1 ){
	    			if(abc.getDutyName().equals(def.getDutyName())) {
	        			...
	        			emRoom.add(new EmRoom(abc.getDutyName(), abc.getTel(), abc.getHv1(),
	        					abc.getHv2(), abc.getHv3(), abc.getHv4(), abc.getHv5(),
	        					abc.getHv6(), abc.getHv7(), abc.getHv8(),
	        					abc.getHv9(), abc.getHv10(), abc.getHv11(), abc.getHv12(),
	        					abc.getHvec(), abc.getHvcc(), abc.getHvccc(), abc.getHvncc(),
	        					abc.getHvicc(), abc.getHpid(), def.getDutyAddr()));
	        			 }
	    			}
	        	 }
